...
def decompose_query(query: str, fast_llm) -> list:
    ...
    # Uses word boundaries to avoid false positives (design, significance).
    # Matches sign, signed, signer/s, signatory/ies, signature/s, and executed.
    sig_pattern = r"\b(sign|signed|signers?|signator(y|ies)|signatures?|executed)\b"
